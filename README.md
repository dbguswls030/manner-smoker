# Manner-Smoker
흡연을 장려하는 어플이 아닌 비흡연자의 간접흡연 문제와 흡연으로 인해 발생하는 문제를 줄이고 흡연자들에게 금연을 장려하도록 하는 어플리케이션이다
- 사용자들이 지정된 구역에서 흡연을 할 수 있도록 흡연 구역 위치를 제공한다.
- 사용자들이 서로 금연과 관련된 이야기를 소통할 수 있도록하는 커뮤니케이션 게시판을 제공한다.
- 사용자에게서 수집된 흡연량 데이터를 활용하여 총 소비액, 마지막 흡연 시간, 흡연 기간 등의 정량적 데이터를 제공하고 흡연 목표량 대비 금일 흡연량을 구분하여 컨디션을 색상별로 표시하여 사용자가 한 눈에 파악할 수 있도록한다.
